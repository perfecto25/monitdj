...
from .views import main, collector
#from .api import api
...
urlpatterns = [
    ...
    path("collector/", csrf_exempt(collector.collector), name="collector"),
    path("dashboard/", main.dashboard, name="dashboard"),
    path("dashboard2/", main.dashboard2, name="dashboard2"),
    path("ack_service/<int:svc_id>/", main.ack_service, name="ack_service"),
    path("host_detail/<uuid:monit_id>/", main.host_detail, name="host_detail"),
    path("host_delete/<uuid:monit_id>/", main.host_delete, name="host_delete")
