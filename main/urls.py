...
urlpatterns = [
    ...
    path("ack/service/<int:svc_id>/", views.ack_service, name="ack_service"),
    path("host/detail/<uuid:monit_id>/", views.host_detail, name="host_detail"),
    path("host/delete/<uuid:monit_id>/", views.host_delete, name="host_delete"),
    path("djadmin/hosts", views.admin_hosts, name="admin_hosts")
